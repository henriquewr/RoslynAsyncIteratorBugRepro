...
namespace RoslynAsyncIteratorBugRepro
{
    ...
    public class IteratorFixed<TSource> : IAsyncEnumerable<TSource>, IAsyncEnumerator<TSource>
    {
        public static IAsyncEnumerable<TSource> Create(CancellationToken cancellationToken)
        {
            return new IteratorFixed<TSource>(cancellationToken);
        }
        ...
        public IteratorFixed(CancellationToken cancellationToken)
        {
        ...
        {
            IteratorFixed<TSource> enumerator;
            ...
            else
            {
                ...
                enumerator._cancellationToken = enumerator._linkedTokens.Token;
            }
