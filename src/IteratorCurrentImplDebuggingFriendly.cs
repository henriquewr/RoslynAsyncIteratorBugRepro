...
{
    /// <summary>
    /// The same implementation of the compiler
    /// </summary>
    /// <typeparam name="TSource"></typeparam>
    public class IteratorCurrentImplDebugFriendly<TSource> : IAsyncEnumerable<TSource>, IAsyncEnumerator<TSource>
    {
        public static IAsyncEnumerable<TSource> Create(CancellationToken cancellationToken)
        {
            return new IteratorCurrentImplDebugFriendly<TSource>(cancellationToken);
        }
        ...
        public IteratorCurrentImplDebugFriendly(CancellationToken cancellationToken)
        {
        ...
        {
            IteratorCurrentImplDebugFriendly<TSource> enumerator;
            ...
            {
                if (_linkedTokens is null)
                {
                    Console.WriteLine("Old instance of _linkedTokens is lost");
                }

                _linkedTokens = CancellationTokenSource.CreateLinkedTokenSource(_cancellationToken, cancellationToken);
